...
public class NQueensVisualizer extends JPanel {
    ...
    public void findAllSolutions() {
        solve(0);
        showTotalSolutions(); // Show total solutions after all have been found
    }
    ...
    private boolean solve(int row) {
        if (row == n) {
            ...
            repaintAndSleep();
            showSolutionFoundPopup(); // Show popup when a solution is found
            return true;
        }
        boolean found = false;
